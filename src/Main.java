...
public class Main {
        public static void main(String[] args) {
                ...
                num1 = EntradaSalida.entradaFloat("Ingrese el numerador, o el radicando, o el numero mas a la izquierda en la escriba occidental");
                num2 = EntradaSalida.entradaFloat("Ingrese el denominador, o el indice, o el numero mas a la derecha en la escriba occidental");
                ...
                if (opcion == "restar" || opcion == "sumar" || opcion == "multiplicar" || opcion == "dividir"|| opcion == "raiz") {
